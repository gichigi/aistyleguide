    ...
    <div className="space-y-6">
      ...
      {selectedTraits.map((trait) => {
        if (isPredefinedTrait(trait)) {
          ...
          return (
            <div key={trait.id} className="p-4 border border-green-200 rounded-lg bg-green-50 animate-in slide-in-from-bottom-2 duration-300">
              <div className="flex items-center gap-2 mb-2">
                <h3 className="font-semibold text-green-900">{trait.name}</h3>
              ...
              <div className="bg-green-100 border border-green-200 rounded-md p-3">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-green-800 mb-1">Built from scratch for your brand</p>
                    <p className="text-xs text-green-600">
                      We'll create a unique description of "{trait.name}" tailored to your industry and audience.
                    </p>
                  </div>
                </div>
              </div>
